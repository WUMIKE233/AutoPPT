...
def get_deepseek_api_key():
    if not DEEPSEEK_API_KEY:
        raise EnvironmentError("请先设置 DEEPSEEK_API_KEY 环境变量 / Please set the DEEPSEEK_API_KEY environment variable.")
...
class PPTGenerator:
    ...
    def call_deepseek_api(self, prompt):
        headers = {"Authorization": f"Bearer {get_deepseek_api_key()}", "Content-Type": "application/json"}
